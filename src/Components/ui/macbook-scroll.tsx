  ...
  return (
    ...
    >
      <motion.h2
        ...
        className="dark:text-white text-white text-3xl font-bold mb-20 text-center"
      >
        {title || (
          <span>
  ...
  return (
    <div className="relative [perspective:800px]">
      ...
      >
        ...
        {/* <iframe width="560" height="315" src="https://youtu.be/1aec7FcVQGs" frameborder="0" allowfullscreen ></iframe> */}
        <iframe width="640" className="object-cover object-left-top absolute rounded-lg inset-0 h-full w-full" height="360" src="https://www.youtube.com/embed/1aec7FcVQGs" title="Get Premium MCA Leads to Grow Your Business | Business Leads World" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>
        {/* <img
