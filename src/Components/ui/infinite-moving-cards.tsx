...
export const InfiniteMovingCards = ({
  ...
  return (
    <div
      ref={containerRef}
      className={cn(
        "scroller  relative z-20  max-w-7xl overflow-hidden  [mask-image:linear-gradient(to_right,white_20%,white_80%)]",
        className
      )}
    >
      <ul
      ...
      >
        {items.map((item, idx) => (
          <li
            className="w-[200px] max-w-full relative bg-dark rounded-2xl border  flex-shrink-0 border-slate-700  p-6 md:w-[200px]"
            style={{
              background:
                "white",
            }}
